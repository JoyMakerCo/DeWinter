...
namespace DeWinter
{
	public static class DialogConsts
	{
		...
		public const string SET_TREND_DIALOG = "set_trend_dialog";
		...
		public const string OUT_OF_CONFIDENCE_DIALOG = "out_of_confidence_dialog";
		public const string OUT_OF_CONFIDENCE_TUTORIAL_DIALOG = "out_of_confidence_tutorial_dialog";
