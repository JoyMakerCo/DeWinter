...
public class EventInventory : MonoBehaviour
{
    ...
    public static List<Event> introEventInventory = new List<Event>();
    ...
    public void StockPartyInventory(Party p)
    {
    ...
    public void StockNightInventory()
    {
        ...
        eventInventories["night"].Add(new Event(1, "A Gift?",
            ...
            new EventStage("“Madamme, there's a man outside and he's very insistent about seeing you.”"
                ...
                new EventOption(GameData.servantDictionary["Bodyguard"], "“Hansel, would you mind searching this man?” <Use Bodyguard>", 4, 75, 5, 25)),
            //Stage 1
        ...
        eventInventories["night"].Add(new Event(1, "A Little Too Much Merriment",
            ...
            new EventStage("A new carriage with a new driver shows up in half an hour. It's inconvenient but still safer than the alternative."
                         ...
                         + "\n\n-You now have " + (GameData.moneyCount - 15) + "Livres", 0, -15,
        ...
        new EventStage("Camille hands brings in the morning paper along with your breakfast. You nearly spit out your tea when read the social pages. The social pages are full of gossip about you and the worst part is, it's mostly true!"
            ...
            new EventOption(GameData.servantDictionary["Bodyguard"], "“Hansel, Pierre is lying about me. Please make him understand how upset I am.” <Use Bodyguard>", 9)),
        //Stage 1
        ...
        new EventStage("The priest eagerly takes the scraps and left overs from this morning's breakfast. “Thank you again, my child. I will pray on your behalf.”"
                    ...
                    + "\n\n-You now have " + (GameData.moneyCount - 15) + " Livres"
        ...
        new EventStage("The priest's eyes widen as you invite him inside to share breakfast with you. He stops to pray over his food before beginning."
                    ...
                    + "\n\n-You now have " + (GameData.moneyCount - 25) + " Livres"
    ...
    void TotalWeights()
    {
        ...
        {
            GameData.totalIntroEventWeight += e.eventWeight;
            Debug.Log("Total Intro Event Weight = " + GameData.totalIntroEventWeight);
        }
