...
namespace DeWinter
{
	public class StartupManager : MonoBehaviour
	{
		void Awake ()
		{
			...
			DeWinterApp.RegisterCommand<CheckMilitaryReputationCmd, FactionVO>();
			...
			DeWinterApp.RegisterCommand<CheckLivreCmd, int>(GameConsts.LIVRE);

			// Initially enabled for FTE
			DeWinterApp.RegisterCommand<StartTutorialCmd>(GameMessages.START_TUTORIAL);
			DeWinterApp.RegisterCommand<TutorialPartyWelcomeCmd, RoomVO>();
