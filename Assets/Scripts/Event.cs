...
public class Event
{
    ...
    //13 Stage Constructor
    public Event(int weight, string title, EventStage s00, EventStage s01, EventStage s02, EventStage s03, EventStage s04, EventStage s05, EventStage s06, EventStage s07, EventStage s08, EventStage s09, EventStage s10, EventStage s11, EventStage s12)
    {
        eventWeight = weight;
        eventTitle = title;
        eventStages.Add(s00);
