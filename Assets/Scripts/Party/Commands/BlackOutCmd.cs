			...
			if (intoxication >= party.MaxIntoxication)
			{
			        ...
			        switch (UnityEngine.Random.Range(0, 10))
			        {
			            case 0:
			                ...
			                party.blackOutEffectAmount = -UnityEngine.Random.Range(20, 51);
			            ...
			            case 4:
			                ...
			                else
			                {
			                    ...
			                    party.blackOutEffectAmount = -UnityEngine.Random.Range(30, 61);
			            ...
			            case 8:
			            	switch (UnityEngine.Random.Range(0, 6))
			            	{
				                ...
				                default:
				                    ...
				                    {
										EnemyVO enemy = party.Enemies[UnityEngine.Random.Range(0, party.Enemies.Length)];
