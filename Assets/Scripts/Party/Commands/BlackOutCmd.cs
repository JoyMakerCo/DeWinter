			...
			if (intoxication >= party.MaxIntoxication)
			{
			        ...
			        switch (rnd.Next(10))
			        {
			            case 0:
			                ...
			                model.Party.Rewards.Add(new RewardVO(RewardType.Reputation, party.blackOutEffectAmount));
			                break;
			            case 1:
			                party.blackOutEffect = "Faction Reputation Loss";
			                party.blackOutEffectAmount = -rnd.Next(20, 51);
							model.Party.Rewards.Add(new RewardVO(RewardType.Faction, party.Faction, party.blackOutEffectAmount));
			                break;
			            case 2:
			            ...
			            case 4:
			                ...
			                else
			                {
			                    ...
			                    model.Party.Rewards.Add(new RewardVO(RewardType.Livre, party.blackOutEffectAmount));
			                }
			                break;
			            case 5:
			                party.blackOutEffect = "Livre Lost";
			            ...
			            case 6:
			                ...
			                break;
			            case 7:
							if (model.Party.Rewards.RemoveAll(r => r.Type == RewardType.Gossip) > 0)
							{
			            ...
			            case 8:
			            	switch (rnd.Next(6))
			            	{
				                ...
				                case 4:
									...
									model.Party.Rewards.Add(new RewardVO(RewardType.Gossip, party.Faction, party.blackOutEffectAmount));
				                    break;
				                default:
