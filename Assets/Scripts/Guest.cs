...
public class Guest: PartyGoer {
    ...
    public lockedInState guestLockedInState;
    ...
    public Guest()
    {
        ...
        guestLockedInState = lockedInState.Interested;
    ...
    {
        if (guestLockedInState != lockedInState.Charmed) //If the Enemy is not Dazed
        {
