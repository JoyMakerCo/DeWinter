...
//TODO: Half of this already exists in StartPartyCmd. Commandify the rest.
    ...
    {
		// If there's no party tonight OR if it's been negatively RSVP'd to
		if (GameData.tonightsParty == null || GameData.tonightsParty.faction == null || GameData.tonightsParty.RSVP < 1 || GameData.tonightsParty.turnsLeft <= 0)
        {
